  ...
  Future<void> _handleFlightSearch(
    ...
    try {
      ...
      if (res.data?.datam?.isNotEmpty ?? false) {
        ...
        res.data!.datam = res.data!.datam
            ?.where((FlightOfferDatam flight) =>
                flight.travelerPricings!.first.fareDetailsBySegment!.first
                    .cabin ==
                event.body['searchCriteria']['flightFilters']
                        ['cabinRestrictions'][0]['cabin']
                    .toString())
            .toList();
